...
val match_orders : Order_book.order_book -> Market_conditions.market_conditions -> Order_types.trade list
(** [match_orders order_book market_conditions] matches buy/sell orders based on price-time priority. *)

val match_all_books : Order_book.order_book list -> Market_conditions.market_conditions -> Order_types.trade list
...
val execute_trade : Order_types.db_order -> Order_types.db_order -> (float * float, string) result
